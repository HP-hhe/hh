...
<jsp:include page="content/head.jsp"></jsp:include>
               ...
               <div class="content">
                  <div class="form">
                   <form>
        			...
        			<li><label>部门名*:</label><input type="text" size="70" id="dpname"/>*</li>
        			<li><label>部门描述:</label><textarea cols="70" rows="5" id="description" wrap="hard"></textarea></li>
    ...
    <div class="body" id="searchresultwrap">
            <div class="div-top">
            	 <div class="title">
                    <h3>查询结果(如果有管理员或者用户在此部门,则不能删除该部门)</h3>
                     <div class="stretch">
                        <img src="images/zd.png" />
                    </div>
                </div>
...
$(document).ready(function() {
	...
	$('#ares').hide();
	$('#u1').show();
	$('#creatdpbtn').click(createdp);
	$('#searchdpdetail').click(searchdp);
	$('#alterdpbtn').click(alterdp);
	$('.menu1  li:eq(0)').addClass('open');
	$('.menu1  li:gt(0)').show();
	$('.menu1  li:eq(3)').addClass('menucurrent');
});
</script>
</html>

	...
	<div class="menuborder">
		<div class="menu1">
			<ul>
				...
				<li>
					<a href="personsetting.jsp">个人信息管理</a>
				</li>
				<li>
					<a href="usersetting.jsp">用户管理</a>
				</li>
				<li>
					<a href="departmentsetting.jsp">部门管理</a>
				</li>
				<li>
					<a href="typesetting.jsp">类别管理</a>
				</li>

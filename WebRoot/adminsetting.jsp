...
<jsp:forward page="nopermission.jsp"></jsp:forward>
<%} %>
               ...
               <div class="content">
                  <div class="form">
                   <form>
        			...
        			<li><label>用户名*:</label><input type="text" size="70" id="username"/>*</li>
        			<li><label>密码*:</label><input type="text" size="70" id="password"/>*</li>
        			<li><label>确认密码*:</label><input type="text" size="70" id="confirmpassword"/>*</li>
                    ...
                    <li><input type="button" id="createadminbtn" value="SUBMIT" /><input type="reset" value="RESET" /></li>
                    </ul>
                    </form>
                </div>
                 </div>
               ...
               <div class="content">
                  <div class="form">
                   <form>
                    ...
                    <li><input type="button" id="searchadmindetail" value="SUBMIT" /><input type="reset" value="RESET" /></li>
                    </ul>
                    </form>
                </div>
                 </div>
...
$(document).ready(function() {
	...
	$('#u1').show();
	$('#createadminbtn').click(createadmin);
	$('#searchadmindetail').click(searchadmin);
	$('.menu1  li:eq(0)').addClass('open');
	$('.menu1  li:gt(0)').show();
	$('.menu1  li:eq(5)').addClass('menucurrent');
});
</script>
</html>
